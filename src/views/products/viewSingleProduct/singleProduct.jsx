...
import { Card, Row, Col, Badge, Button, Image, Typography, Divider, Tag, Space } from 'antd';
import { 
...
const SingleProduct = () => {
  ...
  return (
    <div className="single-product p2" style={{ backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
